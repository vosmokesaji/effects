    ...
    function countDown(config) {
        var defaultOptions = {
            ...
            render: function(outstring) {
                ...
                cdDom.html(outstring);
            },
            end: function() {
                console.log('the end!');
                cdDom.html('the end!');
            },
            endTime: new Date().valueOf() + 0.1 * 1000 * 60
        };
        ...
        getNowTime: function(cb) {
            ...
            xhr.onreadystatechange = function() {
                if (xhr.readyState === 3) {
                    ...
                    console.log("1111111" + new Date(now).valueOf());
...
function timeGose(time){

    var gose = time % (24 * 60 * 60),
        H = gese % (60 * 60),
        S = gese % (60);
